    ...
    <div className="gig">
      <div className="container mx-6 my-6 lg:mx-20 lg:my-20">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2 justify-center	items-center">
          ...
          <div className=" items-start content-start">
            <div class="max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              ...
              <button
                type="button"
                className="w-96 mt-8	text-center focus:outline-none text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
              >
                Continue
              </button>
            </div>
        ...
        <div className="reviews">
          <h2 className="text-xl font-bold mt-20">Reviews</h2>
          <div className=""></div>
          <hr />
          <div className=""></div>
          <hr />
