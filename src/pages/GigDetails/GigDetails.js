...
const Gig = () => {
  ...
  return (
    <div className="gig mt-24 pt-5 md:mt-14">
      {isPending && <Spinner />}
      <div className="container my-8 mx-1 md:mx-20 lg:my-20">
        <p className="text-3xl font-medium text-slate-700 mb-5">{gig.cat}</p>
        <h1 className="text-xl font-normal text-slate-700 mb-2">{gig.title}</h1>
        ...
        <div class="ml-3 grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2 justify-center	items-start">
          <div className="mt-0 mr-12">
            ...
            <p className="mt-3 text-slate-700">{gig.desc}</p>
          </div>
          <div className="mr-3 items-start content-start">
        ...
        <div class="mx-3 mt-8 max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="">
            <div className="flex justify-between">
              <div>
                <div className="my-3">
