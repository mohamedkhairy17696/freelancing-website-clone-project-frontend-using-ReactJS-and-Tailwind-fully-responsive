            ...
            <div className="mt-10 mb-0 lg:mb-12 lg:mt-12">
              ...
              <div className="mb-6 xl:w-96">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                  ...
                  />
                  <button
                    className="relative bg-emerald-700 hover:bg-emerald-800 z-[2] flex items-center rounded-r bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
                    type="button"
                    id="button-addon1"
                    data-te-ripple-init
